...
class EnvRunner(Runner):
    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            if episode % 10 == 0:
                ...
                plt.plot(x1, y1, color="green", linewidth=1.0, linestyle="-")
                plt.plot(x2, y2, color="red", linewidth=1.0, linestyle="-")
                plt.scatter(200, 250, s=300, c='black')
                plt.scatter(230, 175, s=300, c='black')
                plt.scatter(270, 25, s=300, c='black')
    ...
    def collect(self, step):
        ...
        for i in range(self.n_rollout_threads):
            one_hot_action_env = []
            for temp_action_env in temp_actions_env[0]:
